...
exports.alterTable = async function(conn, schema)  {
	...
	try  {
		const  result = await getSchemaManager().alterTable(conn, schema);
		if (schema.title)
...
exports.deleteTable = async function(conn, tbName)  {
	...
	try  {
		const  result = await getSchemaManager().deleteTable(conn, tbName);
...
exports.renameTable = async function(conn, oldName, newName)  {
	...
	try  {
		const  result = await getSchemaManager().renameTable(conn, oldName, newName);
