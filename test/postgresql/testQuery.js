...
describe('Test sql expression', function()  {
    ...
    it('Update', function(done) {
        ...
        soar.execute(option, data, query, function(err) {
            ...
            soar.execute(option, query, function(err, data) {
                ...
                delete  option.query;
                option.update = expr;
                soar.execute(option, {name: 'John Doe'}, query, function(err) {
                    assert(!err, 'Failed to do update.');
                    done();
                });
            });
    ...
    it('Update without specifying table columns and query conditions', function(done) {
        ...
        soar.execute(cmd, data, query, function(err) {
            ...
            soar.execute(cmd, query, function(err, data) {
                ...
                // restore data
                cmd.op = 'update';
                soar.execute(cmd, {name: 'John Doe'}, query, function(err) {
                    assert(!err, 'Failed to do update.');
                    done();
                });
            });
    ...
    xit('Insert and delete with transactions', function(done) {
        var  expr = soar.sql('Person')
                        .column(['psnID', 'name'])
                        .filter( {name: 'psnID', op: '='} );
    ...
    xit('Insert and delete without specifying table columns', function(done) {
        var  expr = soar.sql('Person')
                        .filter( {name: 'psnID', op: '='} );
    ...
    xit('Use join expression to do insert & delete', function(done) {
...
describe('Test short hand', function()  {
    ...
    it('simple query', function(done) {
        soar.query('Person', {name: 'Jane Smith'}, function(err, data) {
    ...
    it('query', function(done) {
        ...
        soar.query(sql, {name: 'Jane Smith'}, function(err, data) {
            assert.equal(data.psnID, 2, 'id is 2');
            done();
        });
    });
